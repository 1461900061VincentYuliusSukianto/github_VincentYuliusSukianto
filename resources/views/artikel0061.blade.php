...
<body>
    ...
    <nav> 
        ...
        <a href="{{url('/home0061/kontak0061')}}">Contact Me</a>
    </nav>
    </div>
    ...
    <br>
    <p><h2>Apa itu Framework?</h2></p>
    <p align="justify">Sesuai dengan namanya sendiri, framework adalah kerangka kerja untuk mengembangkan aplikasi berbasis website maupun desktop. Kerangka kerja disini sangat membantu developer dalam menuliskan sebuah dengan lebih terstruktur dan tersusun rapi.
